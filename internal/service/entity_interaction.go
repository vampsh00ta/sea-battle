...
type EntityInteraction interface {
	shoot(attacker, defender *entity.BattleField, x, y int) (int, error)
	addShip(b *entity.BattleField, p1, p2 entity.Point) (int, error)
}
type entityInteraction struct {
	gameConf *config.Game
}

func newEntityInteraction(gameConf *config.Game) EntityInteraction {
	return &entityInteraction{
		gameConf: gameConf,
	}
}
func (e entityInteraction) shoot(attacker, defender *entity.BattleField, x, y int) (int, error) {
	res := rules.Missed
...
func (e entityInteraction) addShip(b *entity.BattleField, p1, p2 entity.Point) (int, error) {
